...
public final class Asset__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xbde2436d1f60406fL, 0xa6ddb2e955d43687L, 0x3f05b6ba90233f03L, "EnergyDSL.structure.Asset");

  public static final SMethod<Iterable<SNode>> nonEmptyMembers_id58eyHuUgYVm = new SMethodBuilder<Iterable<SNode>>(new SJavaCompoundTypeImpl((Class<Iterable<SNode>>) ((Class) Object.class))).name("nonEmptyMembers").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5912816019931655894L).languageId(0xa6ddb2e955d43687L, 0xbde2436d1f60406fL).build2();
  ...
  public static final SMethod<Boolean> hasItsOwnType_idMIkgqljGnG = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("hasItsOwnType").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(913756863119410668L).languageId(0xa6ddb2e955d43687L, 0xbde2436d1f60406fL).build2();
  public static final SMethod<SNode> createTypeNode_id42g3Tih0Tsk = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("createTypeNode").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4652235545836230420L).languageId(0xa6ddb2e955d43687L, 0xbde2436d1f60406fL).build2();
  public static final SMethod<Iterable<SNode>> effectiveMembers_id1qrYg08iahZ = new SMethodBuilder<Iterable<SNode>>(new SJavaCompoundTypeImpl((Class<Iterable<SNode>>) ((Class) Object.class))).name("effectiveMembers").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1629169468758860927L).languageId(0xa6ddb2e955d43687L, 0xbde2436d1f60406fL).build2();
  public static final SMethod<Boolean> equals_id3i_T7GdgtPy = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("equals").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3793689478284041570L).languageId(0xa6ddb2e955d43687L, 0xbde2436d1f60406fL).build2(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
  ...
  /*package*/ static Iterable<SNode> visibleContentsOfType_id6clJcrJXo2_(@NotNull SNode __thisNode__, SNode targetConcept) {
    IVisibleElementProvider__BehaviorDescriptor.visibleContentsOfTypeAsSequence_id3g6LnlWuSo8.invoke(__thisNode__, SNodeOperations.asSConcept(targetConcept));
    if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(targetConcept), CONCEPTS.Typedef$9m)) {
      return Sequence.fromIterable(SLinkOperations.collectMany(SModelOperations.rootsIncludingImported(SNodeOperations.getModel(__thisNode__), CONCEPTS.Asset$of), LINKS.members$mJj1)).concat(Sequence.fromIterable(SLinkOperations.collectMany(SModelOperations.rootsIncludingImported(SNodeOperations.getModel(__thisNode__), CONCEPTS.Global$eL), LINKS.types$MXIb)));
  ...
  /*package*/ static Iterable<SNode> getDependenciesRelevantForCycleDetection_id59HbAIOYveX(@NotNull SNode __thisNode__) {
    return Sequence.fromIterable(IRecordDeclaration__BehaviorDescriptor.effectiveMembers_id1qrYg08iahZ.invoke(__thisNode__)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SNodeOperations.isInstanceOf(ITypeable__BehaviorDescriptor.type_id4WLweXm3SW5.invoke(it), CONCEPTS.RecordType$z_);
      }
    }).select(new ISelector<SNode, SNode>() {
      public SNode select(SNode it) {
        return SLinkOperations.getTarget(SNodeOperations.cast(ITypeable__BehaviorDescriptor.type_id4WLweXm3SW5.invoke(it), CONCEPTS.RecordType$z_), LINKS.record$jEA7);
      }
    });
  }
  ...
  /*package*/ static SNode createTypeNode_id42g3Tih0Tsk(@NotNull SNode __thisNode__) {
    return createRecordType_rfti0w_a0a01(__thisNode__);
  }
  ...
  /*package*/ static Iterable<SNode> getUniquelyNamedElements_id4qSf1u1TRfj(@NotNull SNode __thisNode__) {
    return ((Iterable<SNode>) Asset__BehaviorDescriptor.effectiveMembers_id1qrYg08iahZ.invoke(__thisNode__));
  }

  /*package*/ Asset__BehaviorDescriptor() {
  }
  ...
  private static SNode createRecordType_rfti0w_a0a01(SNode p0) {
