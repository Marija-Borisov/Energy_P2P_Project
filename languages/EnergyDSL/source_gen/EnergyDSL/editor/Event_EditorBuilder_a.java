...
/*package*/ class Event_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_2() {
    ...
    editorCell.setCellId("Collection_ymj9mh_a1a0");
    editorCell.addEditorCell(createProperty_1());
    editorCell.addEditorCell(createSideTransformationSectionCell_0());
    if (nodeCondition_ymj9mh_a2a1a0()) {
      editorCell.addEditorCell(createCustomFactory_1());
    }
    return editorCell;
  }
  private boolean nodeCondition_ymj9mh_a2a1a0() {
    return Sequence.fromIterable(AttributeOperations.getChildNodesAndAttributes(myNode, LINKS.args$eR5Q)).isNotEmpty();
  }
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "grammar.optional for Event.args") {
      ...
      public List<MenuPart<TransformationMenuItem, TransformationMenuContext>> createMenuParts() {
        return ListSequence.fromListAndArray(new ArrayList<MenuPart<TransformationMenuItem, TransformationMenuContext>>(), new GenericMenuPart_a0b0b0a());
      }
    };
    editorCell.setCellId("SideTransformationSectionCell_ymj9mh_b0b0a");
    return editorCell;
  }
  private class GenericMenuPart_a0b0b0a implements MenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    public List<TransformationMenuItem> createItems(final TransformationMenuContext ctx) {
      ...
      final boolean isApplicable = ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(ctx.getNode(), CONCEPTS.Event$X4), LINKS.args$eR5Q)).isEmpty();
      ...
      if (isApplicable && Sequence.fromIterable(matchingTexts).isNotEmpty()) {
        ListSequence.fromList(items).addElement(new MultiTextActionItem(matchingTexts, ctx) {
          ...
          public SNode doSubstitute(@NotNull String pattern) {
            SNode result = ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(ctx.getNode(), CONCEPTS.Event$X4), LINKS.args$eR5Q)).insertElement(0, SNodeFactoryOperations.createNewNode(CONCEPTS.EventArg$Ph, null));
            EditorContext editorContext = ctx.getEditorContext();
  ...
  private EditorCell createCustomFactory_0(final EditorContext editorContext, final SNode node) {
    ...
    EditorCell editorCell = new _FunctionTypes._return_P0_E0<EditorCell>() {
      public EditorCell invoke() {
        jetbrains.mps.openapi.editor.cells.EditorCell_Collection collection = as_9o0aut_a0a0a0a0a0a4a71(cell, jetbrains.mps.openapi.editor.cells.EditorCell_Collection.class);
        if (collection != null) {
          ...
          for (EditorCell child : Sequence.fromIterable(GrammarCellsUtil.getUnwrappedChildren(collection))) {
            if (Objects.equals(child.getSNode().getContainmentLink(), LINKS.args$eR5Q)) {
              ...
              SNodeReference trace = new SNodePointer("r:19c968f8-ffa0-4ffa-beb4-a94e2b110e3e(EnergyDSL.editor)", "9045495843199336200");
  ...
  private EditorCell createCollection_3() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_ymj9mh_a2a1a0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_ymj9mh_a0c0b0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new argsListHandler_ymj9mh_b0c0b0a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Horizontal(), false);
    editorCell.setCellId("refNodeList_args");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class argsListHandler_ymj9mh_b0c0b0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public argsListHandler_ymj9mh_b0c0b0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(argsListHandler_ymj9mh_b0c0b0a.this.getNode(), LINKS.args$eR5Q));
      try {
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_ymj9mh_c0c0b0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private static <T> T as_9o0aut_a0a0a0a0a0a4a71(Object o, Class<T> type) {
