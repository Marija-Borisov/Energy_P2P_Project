...
/*package*/ class TransactionRef_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public TransactionRef_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_uloeff_a0");
    editorCell.addEditorCell(createConstant_0());
    editorCell.addEditorCell(createRefCell_0());
    editorCell.addEditorCell(createSideTransformationSectionCell_0());
    if (nodeCondition_uloeff_a3a0()) {
      editorCell.addEditorCell(createRefNodeList_0());
    }
    return editorCell;
  }
  private boolean nodeCondition_uloeff_a3a0() {
    return Sequence.fromIterable(AttributeOperations.getChildNodesAndAttributes(myNode, LINKS.constraints$mSZ6)).isNotEmpty();
  }
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "(");
    editorCell.setCellId("Constant_uloeff_a0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.transaction$uHrr;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.transaction$uHrr);
    ...
    provider.setNoTargetText("<no transaction>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.transaction$uHrr);
    }
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    SideTransformationHolderCell editorCell = new SideTransformationHolderCell(getEditorContext(), myNode, null, "grammar.optional for TransactionRef.constraints") {
      @Override
      public List<MenuPart<TransformationMenuItem, TransformationMenuContext>> createMenuParts() {
        return ListSequence.fromListAndArray(new ArrayList<MenuPart<TransformationMenuItem, TransformationMenuContext>>(), new TMP_Group_uloeff_a0c0a());
      }
    };
    editorCell.setCellId("SideTransformationSectionCell_uloeff_c0a");
    return editorCell;
  }
  public class TMP_Group_uloeff_a0c0a extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new GenericMenuPart_a0a2a0(), new TMP_Action_uloeff_b0a2a0());
    }
    ...
    private class TMP_Action_uloeff_b0a2a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      @Nullable
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new constraintsListHandler_uloeff_d0a(myNode, getEditorContext());
  ...
  private static class constraintsListHandler_uloeff_d0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public constraintsListHandler_uloeff_d0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(constraintsListHandler_uloeff_d0a.this.getNode(), LINKS.constraints$mSZ6));
      try {
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink constraints$mSZ6 = MetaAdapterFactory.getContainmentLink(0xbde2436d1f60406fL, 0xa6ddb2e955d43687L, 0x363c0888b3eec542L, 0x363c0888b3eecb95L, "constraints");
    /*package*/ static final SReferenceLink transaction$uHrr = MetaAdapterFactory.getReferenceLink(0xbde2436d1f60406fL, 0xa6ddb2e955d43687L, 0x363c0888b3eec542L, 0x363c0888b3eecc9dL, "transaction");
  }
