...
<model ref="r:55aef295-113d-464d-b21b-06255dbe7e1c(Energy_P2P_Blockchain_Project.__spreferences.PlatformTemplates)">
  ...
  <node concept="2xbcct" id="$orG2IcJxB">
    <node concept="2xbbuh" id="$orG2IcJxD" role="2xbcco">
      <property role="TrG5h" value="Desktop Platform" />
      <node concept="2AWWZL" id="$orG2IcJxC" role="2xbbhh">
