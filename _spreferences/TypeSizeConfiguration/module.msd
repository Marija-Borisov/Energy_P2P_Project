...
<solution name="Energy_P2P_Blockchain_Project.__spreferences.TypeSizeConfiguration" uuid="~_PreferencesModule#Energy_P2P_Blockchain_Project.__spreferences.TypeSizeConfiguration" moduleVersion="0" pluginKind="PLUGIN_CORE" compileInMPS="true">
  <models>
    <modelRoot contentPath="${module}" type="default">
      <sourceRoot location="models" />
    </modelRoot>
    <modelRoot contentPath="${module}/../../lib" type="java_source_stubs" />
  </models>
  <facets>
  ...
  <dependencyVersions>
    <module reference="~_PreferencesModule#Energy_P2P_Blockchain_Project.__spreferences.TypeSizeConfiguration(Energy_P2P_Blockchain_Project.__spreferences.TypeSizeConfiguration)" version="0" />
  </dependencyVersions>
</solution>
